...
class _AfegeixState extends State<Afegeix> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(ConstantsView.LABEL_AFEGIR_LLIBRE),
        actions: [
          _getSaveIconButton(),
        ],
      ),
            ...
            child: Column(
              children: [
                ...
                commonControlsView.getTextFormFieldContingut(
                    (ConstantsVieLABEL_LLIBRE_CONTINGUTUT), commonControlsView.textEditingControllerContingut),
              ],
            ),
          )),
    );
    ...
    return IconButton(
        onPressed: () {
          if (formKey.currentState!.validate()) {
            databaseHelper
         createLlibreeatLlibreModeleModel(
      llibreTitol noteTitle: commonControlsView.textEditingControllerTitol.text,
